...
const Sidebar = () => {
  ...
  function handleLanguageMenuShow() { // english or french
            ...
            <li>
              ...
              {showSubmenu ? (
                <ul className="py-2 space-y-2 ">
                  <Link to="/all-coins">
                    <li>
                      <a href="" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Current Prices</a>
                    </li>
                  </Link>
