    ...
    <div className="px-3 py-3 lg:px-5 lg:pl-3">
        <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
                ...
                <a href="#" className="flex ml-2 md:mr-24"> {/* mr = margin-right: 6rem = 96px */}
        ...
        <div className="flex items-center">
            ...
            <div 
                ...
                id="apps-dropdown" 
                style={{position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate3d(1085px, 65px, 0px)'}}
