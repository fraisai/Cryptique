...
describe('parse update sql',function(){
  ...
  /*{{{ test parse entire update with hint works fine*/
  it("test parse entire update with hint works fine",function(done){
    var sql = "UPdAte /*i am hint*/db.table as tab sEt tab.name = 'ban' ,tab.sex = 'male' where tab.id > 3 and tab.year in (1990,'1991')";
    var expect = {
