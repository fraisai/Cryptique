<>
	<div className="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
					...
					<div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
						<ul className="pb-2 space-y-2">
							...
							<li>
								...
								<ul id="dropdown-crud" className="hidden py-2 space-y-2 ">
									<li>
										<a href="https://flowbite-admin-dashboard.vercel.app/crud/products/" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">
											Products
										</a>
									</li>
									<li>
										<a href="https://flowbite-admin-dashboard.vercel.app/crud/users/" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">
											Users
										</a>
									</li>
								</ul>
							...
							<li>
								...
								<ul id="dropdown-playground" className="hidden py-2 space-y-2 ">
									<li>
										<a href="https://flowbite-admin-dashboard.vercel.app/playground/stacked/" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">
											Stacked
										</a>
									</li>
									<li>
										<a href="https://flowbite-admin-dashboard.vercel.app/playground/sidebar/" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">
											Sidebar
										</a>
									</li>
								</ul>
		...
		<div id="main-content" className="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
				...
				<div className="px-4 pt-6">
					<div className="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
						...
						<div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
							...
							<div id="main-chart" style="min-height: 435px;">
								<div id="apexcharts9hldmerp" className="apexcharts-canvas apexcharts9hldmerp apexcharts-theme-light" style="width: 871px; height: 420px;">
									<svg id="SvgjsSvg2023" width="871" height="420" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" className="apexcharts-svg apexcharts-zoomable" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;">
										<foreignObject x="0" y="0" width="871" height="420">
											<div className="apexcharts-legend apexcharts-align-center apx-legend-position-bottom" xmlns="http://www.w3.org/1999/xhtml" style="inset: auto 0px 1px; position: absolute; max-height: 210px;">
												<div className="apexcharts-legend-series" rel="1" seriesname="Revenue" data:collapsed="false" style="margin: 2px 10px;">
													<span className="apexcharts-legend-marker" rel="1" data:collapsed="false" style="background: rgb(26, 86, 219); color: rgb(26, 86, 219); height: 12px; width: 12px; left: 0px; top: 0px; border-width: 0px; border-color: rgb(255, 255, 255); border-radius: 12px;"></span>
													<span className="apexcharts-legend-text" rel="1" i="0" data:default-text="Revenue" data:collapsed="false" style="color: rgb(107, 114, 128); font-size: 14px; font-weight: 500; font-family: Inter, sans-serif;">
														Revenue
													</span>
												</div>
												<div className="apexcharts-legend-series" rel="2" seriesname="Revenuexxpreviousxperiodx" data:collapsed="false" style="margin: 2px 10px;">
													<span className="apexcharts-legend-marker" rel="2" data:collapsed="false" style="background: rgb(253, 186, 140); color: rgb(253, 186, 140); height: 12px; width: 12px; left: 0px; top: 0px; border-width: 0px; border-color: rgb(255, 255, 255); border-radius: 12px;"></span>
													<span className="apexcharts-legend-text" rel="2" i="1" data:default-text="Revenue%20(previous%20period)" data:collapsed="false" style="color: rgb(107, 114, 128); font-size: 14px; font-weight: 500; font-family: Inter, sans-serif;">
														Revenue (previous period)
													</span>
												</div>
											</div>
										</foreignObject>
										<g id="SvgjsG2025" className="apexcharts-inner apexcharts-graphical" transform="translate(93.796875, 30)">
											<defs id="SvgjsDefs2024">
												<clipPath id="gridRectMask9hldmerp">
													<rect id="SvgjsRect2031" width="751.75" height="315.494" x="-4" y="-2" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
												</clipPath>
												<clipPath id="forecastMask9hldmerp"></clipPath>
												<clipPath id="nonForecastMask9hldmerp"></clipPath>
												<clipPath id="gridRectMarkerMask9hldmerp">
													<rect id="SvgjsRect2032" width="767.75" height="335.494" x="-12" y="-12" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
												</clipPath>
												<linearGradient id="SvgjsLinearGradient2050" x1="0" y1="0" x2="0" y2="1">
													<stop id="SvgjsStop2051" stop-opacity="0.45" stop-color="rgba(26,86,219,0.45)" offset="0"></stop>
													<stop id="SvgjsStop2052" stop-opacity="0" stop-color="rgba(141,171,237,0)" offset="1"></stop>
													<stop id="SvgjsStop2053" stop-opacity="0" stop-color="rgba(141,171,237,0)" offset="1"></stop>
												</linearGradient>
												<linearGradient id="SvgjsLinearGradient2072" x1="0" y1="0" x2="0" y2="1">
													<stop id="SvgjsStop2073" stop-opacity="0.45" stop-color="rgba(253,186,140,0.45)" offset="0"></stop>
													<stop id="SvgjsStop2074" stop-opacity="0" stop-color="rgba(254,221,198,0)" offset="1"></stop>
											...
											<g id="SvgjsG2078" className="apexcharts-xaxis" transform="translate(0, 0)">
												<g id="SvgjsG2079" className="apexcharts-xaxis-texts-g" transform="translate(0, -4)">
													<text id="SvgjsText2081" font-family="Inter, sans-serif" x="0" y="340.494" text-anchor="middle" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-xaxis-label " style="font-family: Inter, sans-serif;">
														<tspan id="SvgjsTspan2082">01 Feb</tspan>
														<title>01 Feb</title>
													</text>
													<text id="SvgjsText2084" font-family="Inter, sans-serif" x="123.95833333333334" y="340.494" text-anchor="middle" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-xaxis-label " style="font-family: Inter, sans-serif;">
														<tspan id="SvgjsTspan2085">02 Feb</tspan>
														<title>02 Feb</title>
													</text>
													<text id="SvgjsText2087" font-family="Inter, sans-serif" x="247.91666666666666" y="340.494" text-anchor="middle" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-xaxis-label " style="font-family: Inter, sans-serif;">
														<tspan id="SvgjsTspan2088">03 Feb</tspan>
														<title>03 Feb</title>
													</text>
													<text id="SvgjsText2090" font-family="Inter, sans-serif" x="371.87499999999994" y="340.494" text-anchor="middle" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-xaxis-label " style="font-family: Inter, sans-serif;">
														<tspan id="SvgjsTspan2091">04 Feb</tspan>
														<title>04 Feb</title>
													</text>
													<text id="SvgjsText2093" font-family="Inter, sans-serif" x="495.8333333333333" y="340.494" text-anchor="middle" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-xaxis-label " style="font-family: Inter, sans-serif;">
														<tspan id="SvgjsTspan2094">05 Feb</tspan>
														<title>05 Feb</title>
													</text>
													<text id="SvgjsText2096" font-family="Inter, sans-serif" x="619.7916666666667" y="340.494" text-anchor="middle" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-xaxis-label " style="font-family: Inter, sans-serif;">
														<tspan id="SvgjsTspan2097">06 Feb</tspan>
														<title>06 Feb</title>
													</text>
													<text id="SvgjsText2099" font-family="Inter, sans-serif" x="743.7500000000001" y="340.494" text-anchor="middle" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-xaxis-label " style="font-family: Inter, sans-serif;">
														<tspan id="SvgjsTspan2100">07 Feb</tspan>
														<title>07 Feb</title>
													</text>
												</g>
											...
											<g id="SvgjsG2033" className="apexcharts-area-series apexcharts-plot-series">
												<g id="SvgjsG2034" className="apexcharts-series" seriesName="Revenue" data:longestSeries="true" rel="1" data:realIndex="0">
													<path
														...
														index="0"
														clip-path="url(#gridRectMask9hldmerp)"
														pathTo="M 0 311.494L 0 172.87917000000016C 43.385416666666664 172.87917000000016 80.57291666666669 226.61188500000026 123.95833333333334 226.61188500000026C 167.34375 226.61188500000026 204.53125000000003 250.75266999999985 247.91666666666669 250.75266999999985C 291.30208333333337 250.75266999999985 328.48958333333337 106.68669499999987 371.875 106.68669499999987C 415.2604166666667 106.68669499999987 452.4479166666667 172.87917000000016 495.83333333333337 172.87917000000016C 539.21875 172.87917000000016 576.40625 211.81592 619.7916666666666 211.81592C 663.1770833333333 211.81592 700.3645833333334 289.68942000000015 743.75 289.68942000000015C 743.75 289.68942000000015 743.75 289.68942000000015 743.75 311.494M 743.75 289.68942000000015z"
														pathFrom="M -1 2647.699L -1 2647.699L 123.95833333333334 2647.699L 247.91666666666669 2647.699L 371.875 2647.699L 495.83333333333337 2647.699L 619.7916666666666 2647.699L 743.75 2647.699"
													></path>
													<path
														id="SvgjsPath2055"
														d="M 0 95.00567000000001C 43.385416666666664 95.00567000000001 80.57291666666669 29.202562500000113 123.95833333333334 29.202562500000113C 167.34375 29.202562500000113 204.53125000000003 146.40218000000004 247.91666666666669 146.40218000000004C 291.30208333333337 146.40218000000004 328.48958333333337 172.87917000000016 371.875 172.87917000000016C 415.2604166666667 172.87917000000016 452.4479166666667 83.32464500000015 495.83333333333337 83.32464500000015C 539.21875 83.32464500000015 576.40625 17.13216999999986 619.7916666666666 17.13216999999986C 663.1770833333333 17.13216999999986 700.3645833333334 71.64361999999983 743.75 71.64361999999983"
														fill="none"
														fill-opacity="1"
														stroke="#fdba8c"
														stroke-opacity="1"
														...
														pathFrom="M -1 2647.699L -1 2647.699L 123.95833333333334 2647.699L 247.91666666666669 2647.699L 371.875 2647.699L 495.83333333333337 2647.699L 619.7916666666666 2647.699L 743.75 2647.699"
													></path>
													<g id="SvgjsG2057" className="apexcharts-series-markers-wrap" data:realIndex="1">
														<g id="SvgjsG2059" className="apexcharts-series-markers" clip-path="url(#gridRectMarkerMask9hldmerp)">
															<circle id="SvgjsCircle2060" r="5" cx="0" cy="95.00567000000001" className="apexcharts-marker no-pointer-events we3jmk6th" stroke="#ffffff" fill="#fdba8c" fill-opacity="1" stroke-width="2" stroke-opacity="0.9" rel="0" j="0" index="1" default-marker-size="5"></circle>
															<circle id="SvgjsCircle2061" r="5" cx="123.95833333333334" cy="29.202562500000113" className="apexcharts-marker no-pointer-events wf2owftrw" stroke="#ffffff" fill="#fdba8c" fill-opacity="1" stroke-width="2" stroke-opacity="0.9" rel="1" j="1" index="1" default-marker-size="5"></circle>
														</g>
														<g id="SvgjsG2062" className="apexcharts-series-markers" clip-path="url(#gridRectMarkerMask9hldmerp)">
															<circle id="SvgjsCircle2063" r="5" cx="247.91666666666669" cy="146.40218000000004" className="apexcharts-marker no-pointer-events wpdeei3p9" stroke="#ffffff" fill="#fdba8c" fill-opacity="1" stroke-width="2" stroke-opacity="0.9" rel="2" j="2" index="1" default-marker-size="5"></circle>
														</g>
														<g id="SvgjsG2064" className="apexcharts-series-markers" clip-path="url(#gridRectMarkerMask9hldmerp)">
															<circle id="SvgjsCircle2065" r="5" cx="371.875" cy="172.87917000000016" className="apexcharts-marker no-pointer-events wucnpmcsj" stroke="#ffffff" fill="#fdba8c" fill-opacity="1" stroke-width="2" stroke-opacity="0.9" rel="3" j="3" index="1" default-marker-size="5"></circle>
														</g>
														<g id="SvgjsG2066" className="apexcharts-series-markers" clip-path="url(#gridRectMarkerMask9hldmerp)">
															<circle id="SvgjsCircle2067" r="5" cx="495.83333333333337" cy="83.32464500000015" className="apexcharts-marker no-pointer-events w2hxvheko" stroke="#ffffff" fill="#fdba8c" fill-opacity="1" stroke-width="2" stroke-opacity="0.9" rel="4" j="4" index="1" default-marker-size="5"></circle>
														</g>
														<g id="SvgjsG2068" className="apexcharts-series-markers" clip-path="url(#gridRectMarkerMask9hldmerp)">
															<circle id="SvgjsCircle2069" r="5" cx="619.7916666666666" cy="17.13216999999986" className="apexcharts-marker no-pointer-events wkcvzjq5s" stroke="#ffffff" fill="#fdba8c" fill-opacity="1" stroke-width="2" stroke-opacity="0.9" rel="5" j="5" index="1" default-marker-size="5"></circle>
														</g>
														<g id="SvgjsG2070" className="apexcharts-series-markers" clip-path="url(#gridRectMarkerMask9hldmerp)">
															<circle id="SvgjsCircle2071" r="5" cx="743.75" cy="71.64361999999983" className="apexcharts-marker no-pointer-events w74cj77mo" stroke="#ffffff" fill="#fdba8c" fill-opacity="1" stroke-width="2" stroke-opacity="0.9" rel="6" j="6" index="1" default-marker-size="5"></circle>
														</g>
													</g>
												</g>
											...
											<rect id="SvgjsRect2136" width="0" height="0" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fefefe" className="apexcharts-zoom-rect"></rect>
											<rect id="SvgjsRect2137" width="0" height="0" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fefefe" className="apexcharts-selection-rect"></rect>
										</g>
										<rect id="SvgjsRect2029" width="0" height="0" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fefefe"></rect>
										<g id="SvgjsG2102" className="apexcharts-yaxis" rel="0" transform="translate(40.796875, 0)">
											<g id="SvgjsG2103" className="apexcharts-yaxis-texts-g">
												<text id="SvgjsText2104" font-family="Inter, sans-serif" x="20" y="31.4" text-anchor="end" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-yaxis-label " style="font-family: Inter, sans-serif;">
													<tspan id="SvgjsTspan2105">$6800</tspan>
													<title>$6800</title>
												</text>
												<text id="SvgjsText2106" font-family="Inter, sans-serif" x="20" y="109.27350000000001" text-anchor="end" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-yaxis-label " style="font-family: Inter, sans-serif;">
													<tspan id="SvgjsTspan2107">$6600</tspan>
													<title>$6600</title>
												</text>
												<text id="SvgjsText2108" font-family="Inter, sans-serif" x="20" y="187.14700000000002" text-anchor="end" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-yaxis-label " style="font-family: Inter, sans-serif;">
													<tspan id="SvgjsTspan2109">$6400</tspan>
													<title>$6400</title>
												</text>
												<text id="SvgjsText2110" font-family="Inter, sans-serif" x="20" y="265.02049999999997" text-anchor="end" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-yaxis-label " style="font-family: Inter, sans-serif;">
													<tspan id="SvgjsTspan2111">$6200</tspan>
													<title>$6200</title>
												</text>
												<text id="SvgjsText2112" font-family="Inter, sans-serif" x="20" y="342.894" text-anchor="end" dominant-baseline="auto" font-size="14px" font-weight="500" fill="#6b7280" className="apexcharts-text apexcharts-yaxis-label " style="font-family: Inter, sans-serif;">
													<tspan id="SvgjsTspan2113">$6000</tspan>
													<title>$6000</title>
												</text>
											</g>
										</g>
										<g id="SvgjsG2026" className="apexcharts-annotations"></g>
									</svg>
									<div className="apexcharts-tooltip apexcharts-theme-light">
										<div className="apexcharts-tooltip-title" style="font-family: Inter, sans-serif; font-size: 14px;"></div>
										<div className="apexcharts-tooltip-series-group" style="order: 1;">
											<span className="apexcharts-tooltip-marker" style="background-color: rgb(26, 86, 219);"></span>
											<div className="apexcharts-tooltip-text" style="font-family: Inter, sans-serif; font-size: 14px;">
										...
										<div className="apexcharts-tooltip-series-group" style="order: 2;">
											<span className="apexcharts-tooltip-marker" style="background-color: rgb(253, 186, 140);"></span>
											<div className="apexcharts-tooltip-text" style="font-family: Inter, sans-serif; font-size: 14px;">
												<div className="apexcharts-tooltip-y-group">
													<span className="apexcharts-tooltip-text-y-label"></span>
													<span className="apexcharts-tooltip-text-y-value"></span>
									...
									<div className="apexcharts-xaxistooltip apexcharts-xaxistooltip-bottom apexcharts-theme-light">
										<div className="apexcharts-xaxistooltip-text" style="font-family: Inter, sans-serif; font-size: 12px;"></div>
									</div>
						...
						<div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
							...
							<div data-popover="" id="popover-description" role="tooltip" className="absolute z-10 invisible inline-block text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(221px, -5956px, 0px);" data-popper-placement="top-start">
								<div className="p-3 space-y-2">
									...
									<a href="#" className="flex items-center font-medium text-primary-600 dark:text-primary-500 dark:hover:text-primary-600 hover:text-primary-700">
										Read more{' '}
							...
							<ul className="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
								<li className="w-full">
									<button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq" aria-selected="true" className="inline-block w-full p-4 text-blue-600 border-blue-600 rounded-tl-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 dark:border-blue-500">
										Top products
									</button>
								</li>
								<li className="w-full">
									<button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about" aria-selected="false" className="inline-block w-full p-4 text-gray-500 border-gray-100 rounded-tr-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-transparent hover:text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300">
										Top Customers
									</button>
								</li>
							</ul>
										...
										<li className="py-3 sm:py-4">
											<div className="flex items-center justify-between">
												<div className="flex items-center min-w-0">
													...
													<div className="ml-3">
														<p className="font-medium text-gray-900 truncate dark:text-white">Apple iMac 27"</p>
														<div className="flex items-center justify-end flex-1 text-sm text-green-500 dark:text-green-400">
															<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
																<path clipRule="evenodd" fillRule="evenodd" d="M10 17a.75.75 0 01-.75-.75V5.612L5.29 9.77a.75.75 0 01-1.08-1.04l5.25-5.5a.75.75 0 011.08 0l5.25 5.5a.75.75 0 11-1.08 1.04l-3.96-4.158V16.25A.75.75 0 0110 17z"></path>
															</svg>
												...
												<div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">$256,982</div>
											</div>
										</li>
										<li className="py-3 sm:py-4">
											<div className="flex items-center justify-between">
												<div className="flex items-center min-w-0">
													...
													<div className="ml-3">
														<p className="font-medium text-gray-900 truncate dark:text-white">Apple Watch SE</p>
												...
												<div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">$201,869</div>
											</div>
										</li>
										<li className="py-3 sm:py-4">
											<div className="flex items-center justify-between">
												<div className="flex items-center min-w-0">
													...
													<div className="ml-3">
														<p className="font-medium text-gray-900 truncate dark:text-white">Apple iPad Air</p>
														<div className="flex items-center justify-end flex-1 text-sm text-green-500 dark:text-green-400">
															<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
																<path clipRule="evenodd" fillRule="evenodd" d="M10 17a.75.75 0 01-.75-.75V5.612L5.29 9.77a.75.75 0 01-1.08-1.04l5.25-5.5a.75.75 0 011.08 0l5.25 5.5a.75.75 0 11-1.08 1.04l-3.96-4.158V16.25A.75.75 0 0110 17z"></path>
															</svg>
												...
												<div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">$103,967</div>
											</div>
										</li>
										<li className="py-3 sm:py-4">
											<div className="flex items-center justify-between">
												<div className="flex items-center min-w-0">
													<img className="flex-shrink-0 w-10 h-10" src="https://flowbite-admin-dashboard.vercel.app/images/products/imac.png" alt="imac image" />
													<div className="ml-3">
														<p className="font-medium text-gray-900 truncate dark:text-white">Apple iMac 24"</p>
														<div className="flex items-center justify-end flex-1 text-sm text-red-600 dark:text-red-500">
															<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
																<path clipRule="evenodd" fillRule="evenodd" d="M10 3a.75.75 0 01.75.75v10.638l3.96-4.158a.75.75 0 111.08 1.04l-5.25 5.5a.75.75 0 01-1.08 0l-5.25-5.5a.75.75 0 111.08-1.04l3.96 4.158V3.75A.75.75 0 0110 3z"></path>
															</svg>
												...
												<div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">$98,543</div>
											</div>
										</li>
									</ul>
								</div>
									...
									<ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
										<li className="py-3 sm:py-4">
											<div className="flex items-center space-x-4">
												...
												<div className="flex-1 min-w-0">
													<p className="font-medium text-gray-900 truncate dark:text-white">Neil Sims</p>
										...
										<li className="py-3 sm:py-4">
											<div className="flex items-center space-x-4">
												...
												<div className="flex-1 min-w-0">
													<p className="font-medium text-gray-900 truncate dark:text-white">Bonnie Green</p>
													<p className="text-sm text-gray-500 truncate dark:text-gray-400">email@flowbite.com</p>
												</div>
										...
										<li className="py-3 sm:py-4">
											<div className="flex items-center space-x-4">
												...
												<div className="flex-1 min-w-0">
													<p className="font-medium text-gray-900 truncate dark:text-white">Michael Gough</p>
													<p className="text-sm text-gray-500 truncate dark:text-gray-400">email@flowbite.com</p>
												</div>
										...
										<li className="py-3 sm:py-4">
											<div className="flex items-center space-x-4">
												...
												<div className="flex-1 min-w-0">
													<p className="font-medium text-gray-900 truncate dark:text-white">Thomes Lean</p>
													<p className="text-sm text-gray-500 truncate dark:text-gray-400">email@flowbite.com</p>
												</div>
										...
										<li className="py-3 sm:py-4">
											<div className="flex items-center space-x-4">
												...
												<div className="flex-1 min-w-0">
													<p className="font-medium text-gray-900 truncate dark:text-white">Lana Byrd</p>
													<p className="text-sm text-gray-500 truncate dark:text-gray-400">email@flowbite.com</p>
												</div>
					...
					<div className="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3">
						<div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
							...
							<div className="w-full" id="new-products-chart" style="min-height: 155px;">
								<div id="apexchartsh0n1f1w2" className="apexcharts-canvas apexchartsh0n1f1w2 apexcharts-theme-light" style="width: 436px; height: 140px;">
									<svg id="SvgjsSvg2138" width="436" height="140" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" className="apexcharts-svg" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;">
										<g id="SvgjsG2140" className="apexcharts-inner apexcharts-graphical" transform="translate(12, 30)">
											<defs id="SvgjsDefs2139">
												<linearGradient id="SvgjsLinearGradient2143" x1="0" y1="0" x2="0" y2="1">
													<stop id="SvgjsStop2144" stop-opacity="0.4" stop-color="rgba(216,227,240,0.4)" offset="0"></stop>
													<stop id="SvgjsStop2145" stop-opacity="0.5" stop-color="rgba(190,209,230,0.5)" offset="1"></stop>
													<stop id="SvgjsStop2146" stop-opacity="0.5" stop-color="rgba(190,209,230,0.5)" offset="1"></stop>
												</linearGradient>
												<clipPath id="gridRectMaskh0n1f1w2">
													<rect id="SvgjsRect2148" width="423" height="100" x="-4.5" y="-2.5" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
												</clipPath>
												<clipPath id="forecastMaskh0n1f1w2"></clipPath>
												<clipPath id="nonForecastMaskh0n1f1w2"></clipPath>
												<clipPath id="gridRectMarkerMaskh0n1f1w2">
													<rect id="SvgjsRect2149" width="418" height="99" x="-2" y="-2" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
												</clipPath>
											</defs>
											<rect id="SvgjsRect2147" width="53.22857142857143" height="95" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke-dasharray="3" fill="url(#SvgjsLinearGradient2143)" className="apexcharts-xcrosshairs" y2="95" filter="none" fill-opacity="0.9"></rect>
											<g id="SvgjsG2168" className="apexcharts-xaxis" transform="translate(0, 0)">
												<g id="SvgjsG2169" className="apexcharts-xaxis-texts-g" transform="translate(0, -4)"></g>
											</g>
											...
											<g id="SvgjsG2150" className="apexcharts-bar-series apexcharts-plot-series">
												<g id="SvgjsG2151" className="apexcharts-series" rel="1" seriesName="Quantity" data:realIndex="0">
													<path
														id="SvgjsPath2155"
														d="M 2.957142857142859 95L 2.957142857142859 17.25Q 2.957142857142859 14.25 5.957142857142859 14.25L 48.18571428571428 14.25Q 51.18571428571428 14.25 51.18571428571428 17.25L 51.18571428571428 17.25L 51.18571428571428 95L 51.18571428571428 95z"
														...
														index="0"
														clip-path="url(#gridRectMaskh0n1f1w2)"
														pathTo="M 2.957142857142859 95L 2.957142857142859 17.25Q 2.957142857142859 14.25 5.957142857142859 14.25L 48.18571428571428 14.25Q 51.18571428571428 14.25 51.18571428571428 17.25L 51.18571428571428 17.25L 51.18571428571428 95L 51.18571428571428 95z"
														pathFrom="M 2.957142857142859 95L 2.957142857142859 95L 51.18571428571428 95L 51.18571428571428 95L 51.18571428571428 95L 51.18571428571428 95L 51.18571428571428 95L 2.957142857142859 95"
														cy="14.25"
														cx="59.60000000000001"
														j="0"
														val="170"
														barHeight="80.75"
													...
													<path
														id="SvgjsPath2157"
														d="M 62.10000000000001 95L 62.10000000000001 12.5Q 62.10000000000001 9.5 65.10000000000001 9.5L 107.32857142857144 9.5Q 110.32857142857144 9.5 110.32857142857144 12.5L 110.32857142857144 12.5L 110.32857142857144 95L 110.32857142857144 95z"
														fill="rgba(26,86,219,1)"
														fill-opacity="1"
														stroke="transparent"
														stroke-opacity="1"
														...
														index="0"
														clip-path="url(#gridRectMaskh0n1f1w2)"
														pathTo="M 62.10000000000001 95L 62.10000000000001 12.5Q 62.10000000000001 9.5 65.10000000000001 9.5L 107.32857142857144 9.5Q 110.32857142857144 9.5 110.32857142857144 12.5L 110.32857142857144 12.5L 110.32857142857144 95L 110.32857142857144 95z"
className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2156" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2158" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2160" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2162" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2164" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2166" className="apexcharts-bar-goals-groups"></g>
													</g>
												</g>
										...
										<g id="SvgjsG2177" className="apexcharts-yaxis" rel="0" transform="translate(-18, 0)"></g>
										<g id="SvgjsG2141" className="apexcharts-annotations"></g>
									</svg>
									<div className="apexcharts-legend" style="max-height: 70px;"></div>
									<div className="apexcharts-tooltip apexcharts-theme-light">
										<div className="apexcharts-tooltip-title" style="font-family: Inter, sans-serif; font-size: 14px;"></div>
										<div className="apexcharts-tooltip-series-group" style="order: 1;">
											<span className="apexcharts-tooltip-marker" style="background-color: rgb(26, 86, 219);"></span>
						...
						<div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
							...
							<div className="w-full" id="week-signups-chart" style="min-height: 155px;">
								<div id="apexcharts8938dncz" className="apexcharts-canvas apexcharts8938dncz apexcharts-theme-light" style="width: 436px; height: 140px;">
									<svg id="SvgjsSvg2283" width="436" height="140" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" className="apexcharts-svg" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;">
										<g id="SvgjsG2285" className="apexcharts-inner apexcharts-graphical" transform="translate(12, 30)">
											<defs id="SvgjsDefs2284">
												<linearGradient id="SvgjsLinearGradient2288" x1="0" y1="0" x2="0" y2="1">
													<stop id="SvgjsStop2289" stop-opacity="0.4" stop-color="rgba(216,227,240,0.4)" offset="0"></stop>
													<stop id="SvgjsStop2290" stop-opacity="0.5" stop-color="rgba(190,209,230,0.5)" offset="1"></stop>
													<stop id="SvgjsStop2291" stop-opacity="0.5" stop-color="rgba(190,209,230,0.5)" offset="1"></stop>
												</linearGradient>
												<clipPath id="gridRectMask8938dncz">
													<rect id="SvgjsRect2293" width="418" height="95" x="-2" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
												</clipPath>
												<clipPath id="forecastMask8938dncz"></clipPath>
												<clipPath id="nonForecastMask8938dncz"></clipPath>
												<clipPath id="gridRectMarkerMask8938dncz">
													<rect id="SvgjsRect2294" width="418" height="99" x="-2" y="-2" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
												</clipPath>
											</defs>
											<rect id="SvgjsRect2292" width="14.785714285714286" height="95" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke-dasharray="3" fill="url(#SvgjsLinearGradient2288)" className="apexcharts-xcrosshairs" y2="95" filter="none" fill-opacity="0.9"></rect>
											<g id="SvgjsG2320" className="apexcharts-xaxis" transform="translate(0, 0)">
												<g id="SvgjsG2321" className="apexcharts-xaxis-texts-g" transform="translate(0, -4)"></g>
											</g>
											...
											<g id="SvgjsG2295" className="apexcharts-bar-series apexcharts-plot-series">
												<g id="SvgjsG2296" className="apexcharts-series" rel="1" seriesName="Users" data:realIndex="0">
													<rect id="SvgjsRect2299" width="14.785714285714286" height="95" x="22.17857142857143" y="0" rx="3" ry="3" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#E5E7EB" className="apexcharts-backgroundBar"></rect>
													<path
														id="SvgjsPath2301"
														d="M 22.17857142857143 95L 22.17857142857143 55.75666666666667Q 22.17857142857143 52.75666666666667 25.17857142857143 52.75666666666667L 33.964285714285715 52.75666666666667Q 36.964285714285715 52.75666666666667 36.964285714285715 55.75666666666667L 36.964285714285715 55.75666666666667L 36.964285714285715 95L 36.964285714285715 95z"
														fill="rgba(26,86,219,1)"
														fill-opacity="1"
														stroke-opacity="1"
														stroke-linecap="round"
														...
														className="apexcharts-bar-area"
														index="0"
														clip-path="url(#gridRectMask8938dncz)"
														pathTo="M
className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2303" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2306" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2309" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2312" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2315" className="apexcharts-bar-goals-groups"></g>
														<g id="SvgjsG2318" className="apexcharts-bar-goals-groups"></g>
													</g>
												</g>
										...
										<g id="SvgjsG2329" className="apexcharts-yaxis" rel="0" transform="translate(-18, 0)"></g>
										<g id="SvgjsG2286" className="apexcharts-annotations"></g>
									</svg>
									<div className="apexcharts-legend" style="max-height: 70px;"></div>
									<div className="apexcharts-tooltip apexcharts-theme-light">
										<div className="apexcharts-tooltip-title" style="font-family: Inter, sans-serif; font-size: 14px;"></div>
						...
						<div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 dark:border-gray-700 dark:bg-gray-800 xl:mb-0">
							...
							<form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
								...
								<article className="mb-5">
									...
									<p className="mb-2 text-gray-900 dark:text-white">Thank you for the workshop, it was very productive meeting. I can't wait to start working on this new project with you guys. But first things first, I'am waiting for the offer and pitch deck from you. It would be great to get it by the end o the month.</p>
								...
								<article className="pl-12 mb-5">
									<footer className="flex items-center justify-between mb-2">
										<div className="flex items-center">
											<p className="inline-flex items-center mr-3 text-sm font-semibold text-gray-900 dark:text-white">
												<img className="w-6 h-6 mr-2 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-1.jpg" alt="Joseph avatar" />
												Joseph McFallen
											</p>
											<p className="text-sm text-gray-600 dark:text-gray-400">
												<time pubdate="" datetime="2022-02-08" title="February 8th, 2022">
							...
							<div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
								<div id="carousel" className="relative" data-carousel="">
									<div className="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
										<div className="absolute inset-0 z-20 transition-transform duration-700 ease-in-out transform translate-x-0 bg-white dark:bg-gray-800" data-carousel-item="">
										...
										<div className="absolute inset-0 z-10 transition-transform duration-700 ease-in-out transform translate-x-full bg-white dark:bg-gray-800" data-carousel-item="">
												...
												<tbody className="bg-white dark:bg-gray-800">
													<tr>
														...
														<td className="inline-flex items-center p-4 space-x-2 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
															<svg className="w-7 h-7" aria-hidden="true" enable-background="new 0 0 780 500" viewBox="0 0 780 500" xmlns="http://www.w3.org/2000/svg">
			...
			{/* FOOTER */}
			<footer className="p-4 mx-4 my-6 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
	...
	<div className="absolute top-0 left-0 z-50 hidden pt-2 datepicker datepicker-dropdown dropdown datepicker-orient-top datepicker-orient-left" style="top: 3411.5px; left: 732.5px;">
		<div className="inline-block p-4 bg-white rounded-lg shadow-lg datepicker-picker dark:bg-gray-700">
			<div className="datepicker-header">
				<div className="px-2 py-3 font-semibold text-center bg-white datepicker-title dark:bg-gray-700 dark:text-white" style="display: none;"></div>
				<div className="flex justify-between mb-2 datepicker-controls">
					<button type="button" className="bg-white dark:bg-gray-700 rounded-lg text-gray-500 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 prev-btn">
						<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
							<path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd"></path>
						</svg>
					</button>
					<button type="button" className="text-sm rounded-lg text-gray-900 dark:text-white bg-white dark:bg-gray-700 font-semibold py-2.5 px-5 hover:bg-gray-100 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-200 view-switch">
						January 2024
					</button>
					<button type="button" className="bg-white dark:bg-gray-700 rounded-lg text-gray-500 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white text-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-gray-200 next-btn">
						<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
							<path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path>
						</svg>
					</button>
			...
			<div className="p-1 datepicker-main">
				<div className="flex datepicker-view">
					<div className="days">
						<div className="grid grid-cols-7 mb-1 days-of-week">
							<span className="h-6 text-sm font-medium leading-6 text-center text-gray-500 dow dark:text-gray-400">Su</span>
							<span className="h-6 text-sm font-medium leading-6 text-center text-gray-500 dow dark:text-gray-400">Mo</span>
							<span className="h-6 text-sm font-medium leading-6 text-center text-gray-500 dow dark:text-gray-400">Tu</span>
							<span className="h-6 text-sm font-medium leading-6 text-center text-gray-500 dow dark:text-gray-400">We</span>
							<span className="h-6 text-sm font-medium leading-6 text-center text-gray-500 dow dark:text-gray-400">Th</span>
							<span className="h-6 text-sm font-medium leading-6 text-center text-gray-500 dow dark:text-gray-400">Fr</span>
							<span className="h-6 text-sm font-medium leading-6 text-center text-gray-500 dow dark:text-gray-400">Sa</span>
						</div>
						<div className="grid w-64 grid-cols-7 datepicker-grid">
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day prev" data-date="1703998800000">
								31
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704085200000">
								1
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704171600000">
								2
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704258000000">
								3
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704344400000">
								4
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704430800000">
								5
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704517200000">
								6
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704603600000">
								7
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704690000000">
								8
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day focused" data-date="1704776400000">
								9
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704862800000">
								10
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1704949200000">
								11
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705035600000">
								12
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705122000000">
								13
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705208400000">
								14
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705294800000">
								15
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705381200000">
								16
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705467600000">
								17
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705554000000">
								18
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705640400000">
								19
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705726800000">
								20
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705813200000">
								21
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705899600000">
								22
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1705986000000">
								23
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706072400000">
								24
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706158800000">
								25
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706245200000">
								26
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706331600000">
								27
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706418000000">
								28
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706504400000">
								29
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706590800000">
								30
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day" data-date="1706677200000">
								31
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1706763600000">
								1
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1706850000000">
								2
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1706936400000">
								3
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1707022800000">
								4
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1707109200000">
								5
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1707195600000">
								6
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1707282000000">
								7
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1707368400000">
								8
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1707454800000">
								9
							</span>
							<span className="flex-1 block text-sm font-semibold leading-9 text-center text-gray-500 text-gray-900 border-0 rounded-lg cursor-pointer datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white day next" data-date="1707541200000">
								10
							</span>
						</div>
					</div>
			...
			<div className="datepicker-footer">
				<div className="flex mt-2 space-x-2 datepicker-controls">
					<button type="button" className="w-1/2 px-5 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg button today-btn dark:bg-blue-600 hover:bg-blue-800 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300" style="display: none;">
						Today
					</button>
					<button type="button" className="w-1/2 px-5 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg button clear-btn dark:text-white dark:bg-gray-700 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 focus:ring-4 focus:ring-blue-300" style="display: none;">
						Clear
					</button>
				</div>
			</div>
	...
	<div className="absolute top-0 left-0 z-50 hidden pt-2 datepicker datepicker-dropdown dropdown datepicker-orient-top datepicker-orient-left" style="top: 3411.5px; left: 958.25px;">
		<div className="inline-block p-4 bg-white rounded-lg shadow-lg datepicker-picker dark:bg-gray-700">
			<div className="datepicker-header">
				<div className="px-2 py-3 font-semibold text-center bg-white datepicker-title dark:bg-gray-700 dark:text-white" style="display: none;"></div>
				<div className="flex justify-between mb-2 datepicker-controls">
	...
	<div className="absolute top-0 left-0 z-50 hidden pt-2 datepicker datepicker-dropdown dropdown datepicker-orient-top datepicker-orient-left" style="top: 5706.2px; left: 733px;">
		<div className="inline-block p-4 bg-white rounded-lg shadow-lg datepicker-picker dark:bg-gray-700">
			<div className="datepicker-header">
				<div className="px-2 py-3 font-semibold text-center bg-white datepicker-title dark:bg-gray-700 dark:text-white" style="display: none;"></div>
				<div className="flex justify-between mb-2 datepicker-controls">
	...
	<div className="absolute top-0 left-0 z-50 hidden pt-2 datepicker datepicker-dropdown dropdown datepicker-orient-top datepicker-orient-left" style="top: 5706.2px; left: 958.5px;">
		<div className="inline-block p-4 bg-white rounded-lg shadow-lg datepicker-picker dark:bg-gray-700">
			<div className="datepicker-header">
				<div className="px-2 py-3 font-semibold text-center bg-white datepicker-title dark:bg-gray-700 dark:text-white" style="display: none;"></div>
				<div className="flex justify-between mb-2 datepicker-controls">
