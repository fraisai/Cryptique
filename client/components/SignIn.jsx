		...
		<div className="flex flex-col pt-16 bg-gray-50 dark:bg-gray-900">
			<div className="relative w-full h-full px-6 pt-16 overflow-y-auto bg-gray-50 lg:ml-60 dark:bg-gray-900" style={{ paddingLeft: '18%', width: '100%' }}>
				<div className="max-w-md p-8 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
					<form className="space-y-6 " action="#">
						...
						<div className="flex space-around" style={{ display: 'flex', justifyContent: 'space-between'}}>
							<div className="flex items-start">
								...
								<label for="remember" className="text-sm font-medium text-gray-900 ms-2 dark:text-gray-300">
									Remember me
								</label>
							</div>
					...
					<button onClick={handleGithubLogin} className="flex items-end justify-center w-full px-1 py-1 mt-4 text-xs border border-gray-200 rounded-lg" style={{ borderColor: 'rgb(229 231 235/var(--tw-border-opacity))'}}>
						<div className='flex mr-2' style={{height: '1.25rem', width: '1rem' }}>
							<GithubSignInSVG />
						</div>
						Sign in with Github
					</button>
						
					<button onClick={handleGoogleLogin} className="flex items-end justify-center w-full px-1 py-1 mt-2 text-xs border border-gray-200 rounded-lg" style={{  borderColor: 'rgb(229 231 235/var(--tw-border-opacity))'}}>
						<div className='flex mr-2' style={{height: '1.25rem', width: '1rem' }}>
							<GoogleSignInSVG />
						</div>
						Sign in with Google
