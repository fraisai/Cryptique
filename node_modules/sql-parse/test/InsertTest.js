...
describe('parse insert sql',function(){
  ...
  /*{{{ test parse entire insert with hint works fine*/
  it('test parse entire insert with hint works fine',function(done){
    var sql = "InsErt /*i am hint*/intO db.testTableValueS ('col1','col2') VAlueS ('a',2,'6')";
    var expect = {
