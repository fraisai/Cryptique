        ...
        return (
            <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul className="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800">
                    <li className="me-2">
                        <button id="about-tab" type="button" className="inline-block p-4 text-blue-600 rounded-ss-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-blue-500" onClick={handleShowChartClick}>Crypto
                    ...
                    <li className="me-2">
                        <button id="services-tab" type="button" className="inline-block p-4 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-300">Chart</button>
                    </li>

                    <li className="me-2">
                        <button id="statistics-tab" data-tabs-target="#statistics" type="button" role="tab" aria-controls="statistics" aria-selected="false" className="inline-block p-4 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-300">About</button>
                    </li>
                </ul>

            <div classNameName="max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">

                <a href="/">
                    {/* <img classNameName="rounded-sm" src={largeImg.current.img} alt="" /> */}
                    <img classNameName="rounded-sm" src="https://assets.coingecko.com/coins/images/32528/large/memecoin_%282%29.png?1698912168" alt="" />
                </a>

                <div classNameName="p-5">
                    <a href="#">
                        <h4 classNameName="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Bitcoin</h4>
                    </a>

                    <p classNameName="mb-3 font-normal text-gray-700 dark:text-gray-400">Price</p>
                    
                    <a href="#" classNameName="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
                    </a>
                </div>
