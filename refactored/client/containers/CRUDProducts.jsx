                    ...
                    <div className="inline-block min-w-full align-middle">
                        <div className="overflow-hidden shadow">
                            <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" style={{width: '200%'}}>
                                    ...
                                    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td className="p-8 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">BTC</td>
                                        <td className="p-8 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">0.2328874 shares</td>
                                        <td className="p-8 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">#194556</td>
                                        <td className="p-8 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">-$22.92</td>
                                        <td className="p-8 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">6.91%</td>
                                        <td className="p-8 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">$2222.04</td>

                                        <td className="p-8 space-x-2 whitespace-nowrap">
                                            <button type="button" id="updateProductButton" className="bg-blue-700 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
