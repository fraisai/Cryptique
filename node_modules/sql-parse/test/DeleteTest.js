...
describe('parse delete sql',function(){
  ...
  /*{{{ test parse entire delete with hint works fine*/
  it('test parse entire delete with hint works fine',function(done){
    var sql = "dElete /*i am hint*/fRom db.table wheRe cid=1";
    var expect = {
